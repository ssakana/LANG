...
def trans_data_to_minicpm_format(file_path) -> List[Dict]:
    ...
    return list(map(transform, json.load(open(file_path))))
...
if __name__ == "__main__":
    ...
    train_dataset = SupervisedDataset(
        data=trans_data_to_minicpm_format(data_args.train_data_path),
        tokenizer=tokenizer,
        model_max_length=training_args.model_max_length,
    )
    eval_dataset = SupervisedDataset(
        data=trans_data_to_minicpm_format(data_args.eval_data_path),
        tokenizer=tokenizer,
        model_max_length=training_args.model_max_length,
    ) if data_args.eval_data_path else None
